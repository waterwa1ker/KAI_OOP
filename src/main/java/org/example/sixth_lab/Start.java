...
//            System.out.println("numbut2 = " + numbut2);
        ...
        but9.addActionListener(e -> {
            if (numbut == 1) {
                ...
                if (MassCont == null) {
                    ...
                    MassCont.Operation(1);
                    counterMassive = MassCont.GetCount();
                    if (text != null) {
                        cP.remove(text);
                        text = null;
                    }
                ...
                if (ListCont == null) {
                    ListCont = new ContList(); // создание пустого контейнера
                    ListCont.Operation(1);
                    counterList = ListCont.GetCount();
                    if (text != null) {
                        cP.remove(text);
                        text = null;
                    }
        ...
        but10.addActionListener(e -> {
            ...
            if (numbut == 1) {
                ...
                if (ListCont != null) {
                    ListCont.Operation(2);
                    iL = ListCont.GetIList();
                    for (int j = 0; j < iL; j++) {
...
//                    ((TTrapeze) trapeze).Set(0);
            ...
            if (numbut == 7) {
                ...
                if (MassCont != null) {
                    ...
                    for (i=0; i<counterMassive; i++) {
                        ...
                        text = new JLabel("Показано " + (i+1) + "/" + counterMassive + " фигур из контейнера-массива");
                        cP.add(text, BorderLayout.SOUTH);
                        cP.validate();
                        cP.revalidate();
                        cP.repaint();
        ...
        but18.addActionListener(e -> {
            if (numbut == 7) {
                ...
                if (ListCont != null) {
                    ListCont.Operation(4);
                    counterList = ListCont.GetCount();
                    if (text != null) {
                        for (iL = 0; iL < counterList; iL++) {
                            cP.remove(ListCont.getFigureFromContList(iL));
                        }
                        cP.remove(text);
                        text = null;
        ...
        but24.addActionListener(e -> {
            if (numbut == 8) {
                if (MassCont == null) { MassCont = new ContMassive(); }
                MassCont.Operation(6);
                counterMassive = MassCont.GetCount();
                i = MassCont.GetIMass();
                if (text != null) {
                    cP.remove(text);
